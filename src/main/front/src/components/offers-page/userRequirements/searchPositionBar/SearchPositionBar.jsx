...
const SearchPositionBar = (props) => {
    ...
    let list = ["Backend",
        "Analyst", "DevOps", "Frontend", "Fullstack", "Project Manager", "QA", "Tester", "Mobile", "Architect", "Support",
        "Tech Lead", "Embedded", "Scrum Master", "Security", "UI/UX Designer", "GameDev", "Data Science/Engineering" ];
    ...
    const handleFilter = (event) => {
        ...
        const newFilter = list.filter((value) => {
            return value.toLowerCase().startsWith(searchPosition.toLowerCase());
        });
        newFilter.sort();
        if(searchPosition === ""){
            setFilteredData([]);
